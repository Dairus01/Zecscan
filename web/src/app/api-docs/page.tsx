...
export default function ApiDocs() {
  ...
  "confirmations": 5
                    ...
                    <ApiEndpoint
                        ...
                        exampleRequest="curl 'https://zecscan.vercel.app/api/blocks?limit=10&offset=0'"
                        exampleResponse={`{
  "blocks": [
    {
      "height": 3000000,
  ...
  "hasShieldedData": false
                    ...
                    <ApiEndpoint
                        ...
                        exampleRequest="curl https://zecscan.vercel.app/api/mempool"
                        exampleResponse={`{
  "count": 5,
  "transactions": [
    {
    ...
    "transparent": 3
                ...
                <section id="privacy-stats" className="space-y-8">
                    ...
                    <ApiEndpoint
                        ...
                        exampleRequest="curl https://zecscan.vercel.app/api/privacy-stats"
                        exampleResponse={`{
  "metrics": {
    "privacyScore": 85,
...
// Fetch privacy stats
const stats = await fetch('https://zecscan.vercel.app/api/privacy-stats');
...
# Fetch mempool
mempool = requests.get('https://zecscan.vercel.app/api/mempool')
