 ...
 * @param {number} blocks_to_scan
 * @returns {string}
 */
export function scan_for_transactions(viewing_key, blocks_to_scan) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(viewing_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.scan_for_transactions(ptr0, len0, blocks_to_scan);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function decrypt_memo(viewing_key, tx_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(viewing_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_2be9bc5af7ad6aed = function(arg0, arg1) {
